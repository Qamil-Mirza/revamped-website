...
const challenges: MonthChallenge[] = [
  ...
  },
  {
    month: "February",
    year: 2026,
    title: "Receipt Extractor - Document AI for Line Item Parsing",
    description: "A self-hosted receipt scanner using Document Understanding Transformers and OCR to automatically extract line items from receipts. Deployed on a Linux mini PC with NGINX restricting traffic to local network devices.",
    status: "completed",
    tags: ["Python", "Document Understanding Transformers", "OCR", "NGINX", "Linux"],
    videoLink: "https://www.tiktok.com/@therealqamil/video/7612046647090040077?_r=1&_t=ZT-94JLl6HoFeY",
    highlights: [
